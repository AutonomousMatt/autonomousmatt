...
async function ask() {
  ...
  const keywordMap = {
    // ... [unchanged keywordMap as you have above]
  };
  ...
  // ✅ SPECIAL OVERRIDE: force this file if prompt contains "product manager"
  if (prompt.includes("product manager")) {
    matchedFiles = ["/story_how-to-be-a-great-product-manager.txt"];
  }
