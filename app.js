...
async function ask() {
  ...
  const keywordMap = {
    ...
    "british": ["/film_long-good-friday.txt", "/film_legacy-of-zulu-dawn.txt"],
    ...
    "war": ["/film_war-and-peace.txt", "/film_napoleon.txt", "/film_legacy-of-zulu-dawn.txt"],
    ...
    "career": ["/story_how-to-be-a-great-product-manager.txt", "/story_twenty-things-in-twenty-years.txt", "/story_life-in-art.txt"],
