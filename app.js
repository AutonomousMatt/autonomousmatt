...
async function ask() {
  ...
  "values": ["/story_the-ten-year-cycle.txt"],
    "python": ["/story_baron-munchausen.txt"],
    "gilliam": ["/story_baron-munchausen.txt"],
    "fantasy": ["/story_baron-munchausen.txt"],
    "monty": ["/story_baron-munchausen.txt"],
    "comedy": ["/story_baron-munchausen.txt"],
